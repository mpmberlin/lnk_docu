...
|-------------|------------------------------------|-------------------------------------------------------------------------|
| 400         | `400-SEARCH-BAD-REQUEST`           | Invalid request, e.g. Missing search term or identity       |
| 401         | `401-UNAUTHORIZED`                 | Missing or invalid credentials                                          |
| 401         | `401-EXPIRED_TOKEN`                | Token is expired                                                        |
| 429         | `429-THROTTLED`                    | Too many requests; respect the `Retry-After` header before retrying     |
| 500         | `500-INTERNAL-ERROR`               | Unexpected server error                                                 |


```js
{
   "code": "400-SEARCH-BAD-REQUEST",
  "message": "Missing search term or identity"
}
